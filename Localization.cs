...
namespace TeknoParrotBigBox
{
    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["MsgBackToParrotConfirm"] = "是否退出 BigBox 并启动 TeknoParrot 官方 UI？",
            ["TitleBackToParrotConfirm"] = "返回鹦鹉 UI",
            ["ButtonBackToParrotConfirm"] = "返回鹦鹉",
            ["ButtonExitProgram"] = "推出程序",
            ["LabelArcade"] = "街机",
            ["LabelFavoriteIndicator"] = "★ 已收藏",
            ["LabelNoPreviewVideo"] = "无预览视频",
            ["MenuAddVideo"] = "添加视频",
            ["CaptionTip"] = "提示",
            ["CaptionError"] = "错误",
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["MsgBackToParrotConfirm"] = "Exit BigBox and launch the official TeknoParrot UI?",
            ["TitleBackToParrotConfirm"] = "Back to Parrot UI",
            ["ButtonBackToParrotConfirm"] = "↩  Back to Parrot",
            ["ButtonExitProgram"] = "⏻  Exit Program",
            ["LabelArcade"] = "Arcade",
            ["LabelFavoriteIndicator"] = "★ Favorited",
            ["LabelNoPreviewVideo"] = "No Preview Video",
